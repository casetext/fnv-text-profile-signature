...
public class FNVTest {
    ...
    public void test() throws Exception {
        ...
        assertEquals("'''", "bGInLge7AUJiuCF1YpXFjQ", FNV.hash(""));
        assertEquals("'a'", "0ijLaW8ajK94kStwTkqJZA", FNV.hash("a"));
        assertEquals("'aa'", "CICVRLqrG-laoHMwVbaZJw", FNV.hash("aa"));
        assertEquals("'hello world'", "bBVXmf3I7sS5FSOAjncmtw", FNV.hash("hello world"));
        assertEquals("'" + allGoodMen + "'", "UbOOWhy3VrMOicJCTfUw8w", FNV.hash(allGoodMen));
        assertEquals("<declaration text signature>", "jqTeG2smiMPNKGsxmksCqA", FNV.hash(declaration));
